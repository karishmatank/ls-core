/*
Read the JavaScript code below. Given the code, create the HTML that matches the DOM rendered by the browser.
You don't need to account for the text nodes when creating the HTML.
The challenge of this exercise is trying to picture what the HTML will be without running the code.
At the very least, try attempting it first with pen and paper. Assume that the following HTML is the starting point:
...
I didn't worry about empty nodes when crafting the HTML below:
...
Just missed originally that setting node4.type creates a new type attribute with value 'text/css'.
*/