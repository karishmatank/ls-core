"""
Building on the prior question, we now must also track a basic motorboat. 
...
"""
Important thing here is that a Motorboat is not a Catamaran, so we can't have Motorboat just inherit from Catamaran.
"""