...
Join the two together, separated by a space, and store the result in a variable named fullName.
...
/*
Split the fullName variable into an array that contains the first and last names as separate strings.
Log the value of the array.
*/
...
Find the index of the first occurrence of the letter 'S' and save it to a variable named idx variable.
Log the value of idx.
*/
...
/*
Create two variables, a = 'a' and b = 'b'. Log a "greater than" comparison between the two variables.
Reassign the value 'B' to variable b, then compare the two variables again, and log the comparison value.
*/
...
b = 'B';
console.log(a > b); // Should log true
...
console.log(language.substring(1, 4)); // Same as above
console.log(language.substring(2, 4)); // Same as above
...
Combine the values of the two variables with the string ' and ' between them, and store the result in a
variable named compoundSentence. Make sure the first letter of fact2 shows up as lowercase in compoundSentence.
...
Search the resulting string for the final occurrence of '14', and log its index position.
*/
...
/*
Create a variable named boxNumber and set it to the result of calling 356.toString(),
and log the result. Before moving on, try to run your program.
*/

// let boxNumber = 356.toString(); // Error b/c JS interprets the . as a decimal point

/* One way to avoid this is to use two periods instead of one.
Replace 356.toString() with 356..toString(), and try running it again. */

let boxNumber = 356..toString();
console.log(boxNumber);

/*
Some "linter" programs reject this usage, and instead suggest that you use parentheses.
Update your program again: eliminate the second period, and place 356 in parentheses, then run the program again.
*/
...
To make sure the result is a number, you can log typeof boxNumber to verify the type of the result.
Now convert the number back to a String by using the String function and log the typeof of the result
to verify it is now a String.
*/
