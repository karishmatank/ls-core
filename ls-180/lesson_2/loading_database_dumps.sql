/* Off of database loaded from films.sql */
...
director, which will hold a director's full name, and 
duration, which will hold the length of the film in minutes. */
...
SELECT title, 2026 - "year" AS age -- Can replace with extract('year' from current_date) - "year" AS age
FROM films
ORDER BY age asc;
