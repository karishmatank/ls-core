...
/*
The issue is with `updateCart('pencil', 0);`- inside `updateCart`, this would translate to
`amount = 0 || 1`. `0` is the true amount though, however `amount` would take on the value `1`
because 0 is falsy. We should instead check whether `amount === undefined` before defaulting to the value 1.
