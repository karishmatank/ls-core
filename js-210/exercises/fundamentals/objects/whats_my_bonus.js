...
/*
This works because of the built-in arguments object, which captures the arguments passed in to the function.
Even though we didn't specify any parameters, the `arguments` object will still capture any argument passed in.
*/