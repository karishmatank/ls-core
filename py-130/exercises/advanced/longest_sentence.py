...
def longest_sentence(text):
    ...
    sentences.sort(key=get_word_count, reverse=True)

    longest_sentence = sentences[0]
    print(f"{longest_sentence}\n")
    print(f"The longest sentence has {get_word_count(longest_sentence)} words.")


# Note: Could just do longest = max(sentences, key=get_word_count) to find longest instead of sorting everything.
